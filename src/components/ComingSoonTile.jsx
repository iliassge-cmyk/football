...
export default function ComingSoonTile({ name = 'New Challenge' }) {
  return (
    <div className="relative flex h-full flex-col justify-between rounded-2xl border border-white/10 bg-white/[0.03] p-5 opacity-60 cursor-not-allowed overflow-hidden">
      ...
      `}</style>
      <span className="absolute top-4 right-4 inline-flex items-center gap-1 rounded-full bg-white/10 px-2.5 py-1 text-[11px] font-semibold text-white/70">
        <Lock weight="fill" size={12} /> Coming Soon
      </span>
      <div>
        <div className="mb-3 text-white/70" aria-hidden="true">
