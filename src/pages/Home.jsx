...
const GAMES = [
  ...
  { to: '/game/minefield', name: 'Minefield', tagline: '10 safe tiles, 6 mines. Just for fun.', icon: '💣', badge: 'Unranked' },
  { to: '/game/daily-top10', name: 'Daily Top 10', tagline: 'Name all 10. One ranked shot a day.', icon: '🏆', badge: 'Daily' },
]
